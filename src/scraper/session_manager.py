...
def save_session(driver, session_file: str = str(SESSION_FILE_DEFAULT)) -> None:
    ...
    log_event("DEBUG", {"msg": "session_save_start", "session_file": session_file})
    ...
    try:
        ...
        log_event("ERROR", {"msg": "session_save_error", "component": "cookies", "error": str(e)})
    else:
        # Log cookie capture immediately for diagnostics
        cookie_count = len(session.get("cookies", []))
        log_event("DEBUG", {"msg": "session_cookies_captured", "cookie_count": cookie_count})

    try:
        ua = driver.execute_script("return navigator.userAgent")
        session["user_agent"] = ua
    except Exception as e:
        log_event("ERROR", {"msg": "session_save_error", "component": "user_agent", "error": str(e)})
    ...
    try:
        ...
        log_event("ERROR", {"msg": "session_save_error", "component": "profile_path", "error": str(e)})
    ...
    try:
        ...
        log_event("ERROR", {"msg": "session_save_error", "component": "file_write", "error": str(e)})
